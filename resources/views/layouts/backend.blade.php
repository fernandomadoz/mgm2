...
$permiso_gestor = array(1,2);
$permiso_cliente = array(1,2,3);


if (Auth::user()->file_imagen_de_perfil <> '') {
  $file_imagen_de_perfil = env('PATH_PUBLIC').'storage/'.Auth::user()->file_imagen_de_perfil;
}
else {
...
<head>
  ...
  <title>MGM 2.0 | Mas Semillas</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo env('PATH_PUBLIC')?>" class="logo">
      ...
      <i class="fa fa-fire"></i> MGM 2.0 </span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <?php if (in_array($nivel_de_acceso, $permiso_cliente)) { ?>
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
              <li><a href="<?php echo env('PATH_PUBLIC')?>list/Orden_de_trabajo/7"><i class="fa fa-file-text-o"></i> Mis Ordenes de Trabajo</a></li>              
              <?php if (in_array($nivel_de_acceso, $permiso_gestor)) { ?>
                <li><a href="<?php echo env('PATH_PUBLIC')?>list/Orden_de_trabajo/0"><i class="fa fa-file-text-o"></i> Ordenes de Trabajo</a></li>              
